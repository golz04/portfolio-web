...
function Projects() {
    return(
        <div className="relative">
            <section className="container mx-auto sm:px-4 my-10 mb-20">
                ...
                <div className="flex flex-wrap gx-lg-5">
                    <div className="lg:w-1/3 pr-4 pl-4 md:w-full pr-4 pl-4 mb-4 lg:mb-0">
                    ...
                    <div className="lg:w-1/3 pr-4 pl-4 mb-4 lg:mb-0">
                        <div className="relative flex flex-col min-w-0 rounded break-words bg-white shadow-lg">
                            ...
                            <div className="flex-auto p-6 bg-gray-100">
                                <h5 className="text-center mb-1 font-bold text-2xl">Kolabordik</h5>
                                <h6 className="text-center text-blue-600 font-semibold mb-3">Mobile Apps</h6>
