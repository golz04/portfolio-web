...
function Header() {
    return(
        <div className="relative">
            <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" className="absolute m-auto block w-full h-max" style={{zIndex: 0}} preserveAspectRatio="none" viewBox="0 0 1920 880">
                <g transform="translate(960,440) scale(1,1) translate(-960,-440)">
                    <linearGradient id="lg-0.047955344060927496" x1={0} x2={1} y1={0} y2={0}>
                        <stop stopColor="hsl(206.57,89.74%,54.12%)" offset={0} />
                        <stop stopColor="hsl(186.79,100.00%,41.57%)" offset={1} />
                    </linearGradient>
                    <path fill="url(#lg-0.047955344060927496)" opacity="0.4">
            ...
            <div className="container pt-40 md:pt-32 mb-10 px-6 mx-auto">
                <section className="text-gray-800 text-center lg:text-left" style={{height: '100%',}}>
                    <div className="container mx-auto xl:px-32 text-center lg:text-left">
                        <div className="grid lg:grid-cols-2 flex items-center">
                            <div className="mb-12 lg:mb-0 md:ml-10">
